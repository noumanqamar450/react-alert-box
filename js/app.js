...
demoAsyncAlert = () => {
  ...
  document.getElementById("alertMessage").innerText =
    "This will disconnect all clients and cannot be undone.";
...
toggleMobileMenu = () => {
  ...
  mobileMenuBar.classList.toggle("fa-bars");
  mobileMenuBar.classList.toggle("fa-remove");
};
